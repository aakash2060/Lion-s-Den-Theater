    ...
    <footer className="bg-black text-gray-400 text-center py-8 border-t border-gray-700 mt-auto">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center space-x-6 mt-4">
          <a href="/discover-movies" className="hover:text-primary transition duration-300">
            Discover Movies
          </a>
          <a href="/food-drinks" className="hover:text-primary transition duration-300">
            Food & Drinks
          </a>
          <a href="/membership" className="hover:text-primary transition duration-300">
            Membership
          </a>
