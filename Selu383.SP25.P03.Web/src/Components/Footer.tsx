    ...
    <footer className="bg-black text-gray-400 text-center py-8 border-t border-gray-700 mt-auto">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center space-x-6 mt-4">
          <a href="/discover-movies" className="hover:text-primary transition duration-300">Discover Movies</a>
          <a href="/food-drinks" className="hover:text-primary transition duration-300">Food & Drinks</a>
          <a href="/membership" className="hover:text-primary transition duration-300">Membership</a>
        ...
        <div className="flex justify-center space-x-6 mt-6">
          ...
          <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-red-500 transition duration-300">
            <FaYoutube size={24} />
          </a>
        </div>

        {/* Copyright */}
        <p className="text-sm text-gray-500 mt-6">© {new Date().getFullYear()} Lion's Den Theater. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
